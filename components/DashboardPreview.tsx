  ...
  return (
    <div className="flex justify-center">
      <div className="relative w-full max-w-4xl px-4">
        ...
        <div className="relative bg-white dark:bg-zinc-900 rounded-[1.5rem] sm:rounded-[2rem] p-4 sm:p-8 border border-zinc-200 dark:border-zinc-800 shadow-2xl">
          {/* Background Gradient */}
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-violet-600 rounded-lg flex items-center justify-center text-white text-xs font-black italic">
                  S
                </div>
            ...
            <div className="mt-4 sm:mt-6 text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 font-medium">
              💡 Select a file type above to see how it works
            </div>
          </div>
        </div>
      </div>

...
import { formatBytes, getFileIcon, getMetaIcon, getColorClass } from '../utils/helpers';
      ...
      <div className="p-6 space-y-8 h-full overflow-y-auto custom-scrollbar">
        <section>
          <div className="flex items-center justify-between mb-6 pb-2 border-b border-zinc-100 dark:border-zinc-800">
            ...
            <button onClick={() => dispatch({ type: 'SET_SIDEBAR_OPEN', payload: false })} className="p-1 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded text-zinc-400">

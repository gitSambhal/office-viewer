...
const App: React.FC = () => {
  ...
  // Handle PWA Launch Queue (Files sent from OS/Share)
  useEffect(() => {
      ...
      <div className="dropzone-overlay">
        <div className="bg-white dark:bg-zinc-900 p-16 rounded-[4rem] shadow-2xl flex flex-col items-center gap-8 animate-in zoom-in duration-300 border-2 border-violet-100 dark:border-violet-900/30">
           ...
           <div className="text-center">
             ...
             <p className="text-zinc-500 dark:text-zinc-400 font-bold uppercase tracking-widest text-[11px]">Secure Offline Workstation</p>
           </div>
        </div>
      </div>
